...
let wordFromCodePoints = String.fromCharCode(codePoints[0], codePoints[1], codePoints[2], codePoints[3]);

// Task 3
let inputString2 = "Launch";
let firstCharacter = inputString2.charCodeAt(0);
let lastCharacter = inputString2.charCodeAt(inputString2.length - 1);
let swappedString = String.fromCharCode(lastCharacter) + "aunc" + String.fromCharCode(firstCharacter); // Your code here
